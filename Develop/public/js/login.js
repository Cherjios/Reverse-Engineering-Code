$(document).ready(function() {
  ...
  loginForm.on("submit", function(event) { //This function creates a obj with the email and password typed by the user
...
// This if statement makes function to return if either password and email are empty inputs 
  ...
  function loginUser(email, password) {
    $.post("/api/login", {//This function will post on api/login the email and password input by the user 
      ...
      .then(function() {//This function will send the user to the route members after login
